        ...
        <div className={style.info}>
          <div className={style.infoBox}>
            ...
            <p className={style.aboutMe}>
              With a deep interest in programming, especially in web and mobile
              app development, I have a strong background as a full-stack web
              developer. I am an active person who enjoys working in teams,
              particularly in my lifelong passion for technology.
            </p>
          </div>
          <div className={style.infoBox}>
